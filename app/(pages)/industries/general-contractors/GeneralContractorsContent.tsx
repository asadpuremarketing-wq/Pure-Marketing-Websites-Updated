...
const RESULTS = [
  { metric: "250%+", label: "Lead Increase",     client: "Gravity Contractors",         detail: "Went from 3 referrals/month to 12+ inbound leads." },
  { metric: "3x",    label: "Revenue Growth",    client: "BuildRight Construction",      detail: "Scaled from $400K to $1.2M in annual revenue in 14 months." },
  { metric: "4 mo.", label: "Fully Booked",      client: "Summit General Contracting",   detail: "Booked out 4 months in advance within the first quarter." },
];
      ...
      <section className="bg-[#f5f5f5] py-24">
        <div className="max-w-[1240px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
            {RESULTS.map(({ metric, label, client, detail }, i) => (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-10">
            {[
              { name: "Ahmed R.",  company: "Gravity Contractors",       result: "250%+ More Leads",     dur: "1:42" },
              { name: "James T.",  company: "BuildRight Construction",    result: "Fully Booked in 90 Days", dur: "2:05" },
              { name: "Sarah M.",  company: "Summit General Contracting", result: "Top Google Rankings",  dur: "1:58" },
            ].map(({ name, company, result, dur }, i) => (
