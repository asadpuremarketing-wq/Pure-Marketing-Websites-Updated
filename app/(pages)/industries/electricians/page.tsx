...
export const metadata = {
  title: "Marketing for Electricians | Pure Marketing",
  description:
    "We help electricians in Canada get a predictable flow of emergency calls, panel upgrades, and residential jobs - without relying on referrals.",
};
